...
In a **nested design**, each level of the nested predictor is uniquely associated with only one level of the higher-level predictor.

In a **crossed (or factorial) design**, at least one level of each predictor is associated with more than one level of the other predictors. Crossed designs can further be separated into partially or fully crossed.

This basic categorization of the study design does not depend on whether factors are fitted as fixed or random effects.
